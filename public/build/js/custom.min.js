...
function init_skycons() {
    if ("undefined" != typeof Skycons) {
        ...
        var c, a = new Skycons({color: "#931A1D"}), b = ["clear-day", "clear-night", "partly-cloudy-day", "partly-cloudy-night", "cloudy", "rain", "sleet", "snow", "wind", "fog"];
    ...
    if (console.log("run_datatables"), "undefined" != typeof $.fn.DataTable) {
        ...
        var a = function () {
            $("#datatable-buttons").length && $("#datatable-buttons").DataTable({
                dom: "lfrtBp",
                language: {
                    url: "/build/js/datatables-plugins/i18n/english.json"
                },
